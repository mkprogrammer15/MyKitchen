  ...
  Widget build(BuildContext context) => TextFormField(
        ...
        validator: (text) {
          if (text == null || text.isEmpty) {
            return AppLocalization.of(context)!.getTranslatedValues('Die Küchenlänge soll mindestens 1m sein');
          }
          return null;
        },
        decoration: InputDecoration(
            hintText: AppLocalization.of(context)!.getTranslatedValues('In Meter'),
            labelText: AppLocalization.of(context)!.getTranslatedValues('Wie lang ist Ihre Küche?'),
            suffixIcon: const Icon(Icons.linear_scale)),
