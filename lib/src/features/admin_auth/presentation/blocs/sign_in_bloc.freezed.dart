...
class _$_SignInState implements _SignInState {
  ...
  @override
  String toString() {
    return 'SignInState(emailAddress: $emailAddress, password: $password, isSubmitting: $isSubmitting, authFailureOrSuccessOption: $authFailureOrSuccessOption, showErrorMessages: $showErrorMessages)';
  }
...
abstract class _SignInState implements SignInState {
  const factory _SignInState(
      ...
      required bool isSubmitting,
      required Option<Either<AuthFailure, Unit>> authFailureOrSuccessOption,
      required bool showErrorMessages}) = _$_SignInState;
