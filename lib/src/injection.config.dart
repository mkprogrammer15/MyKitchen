...
import 'features/admin_orders/data/data_sources/request_data_source.dart'
    as _i4;
import 'features/admin_orders/data/repositories/request_repository_impl.dart'
    as _i6;
import 'features/admin_orders/domain/repositories/request_repository.dart'
    as _i5;
import 'features/admin_orders/presentation/blocs/bloc/requests_bloc.dart'
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i4.RequestDataSource>(() => _i4.RequestDataSource());
  gh.lazySingleton<_i5.RequestRepository>(() => _i6.RequestRepositoryImpl(
      requestDataSource: get<_i4.RequestDataSource>()));
  gh.factory<_i7.RequestsBloc>(
      () => _i7.RequestsBloc(requestRepository: get<_i5.RequestRepository>()));
